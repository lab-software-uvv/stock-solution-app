...
namespace StockSolution.Api.Validators.ProdutoComercial;

public class CreateComercialProductRequestValidator : Validator<CreateComercialProductRequest>
{
    public CreateComercialProductRequestValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
            .MaximumLength(255)
